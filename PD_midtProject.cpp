...
void input(int [], int m); // for data input (array)
double disBetween(double x1, double y1, double x2, double y2); // calculate the distance between two points
...
double disBetween(double x1, double y1, double x2, double y2) {
